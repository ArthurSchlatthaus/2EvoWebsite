        ...
        <div id="ranking" class="table">
            @if(!empty($ranking_all_guild))
                <div class="table-row headline">
                    ...
                    <div class="table-cell">{{ __('messages.leader') }}</div>
                    <div class="table-cell">{{ __('messages.member') }}</div>
                    <div class="table-cell empire">{{ __('messages.empire') }}</div>
                </div>

                @foreach ($ranking_all_guild as $id => $row)
                    <div class="table-row">
                        ...
                        <div class="table-cell">{{ $row->member }}</div>
                        <div class="table-cell empire">
